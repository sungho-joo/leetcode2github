...
# If there are multiple valid answers,return any of them.If no such array exists,
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_2028.py")])
