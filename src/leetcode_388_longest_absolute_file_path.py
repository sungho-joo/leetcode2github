...
# all concatenated by '/'s.Using the above example,the absolute path to file2.
# ext is "dir/subdir2/subsubdir2/file2.ext".Each directory name consists of letters,digits,
...
class Solution:
    def lengthLongestPath(self, input: str) -> int:
        ...
        for path in paths:
            ...
            if "." not in name:
                path_dict[depth + 1] = path_dict[depth] + name_len + 1
            else:
                max_len = max(max_len, path_dict[depth] + name_len)
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_388.py")])
