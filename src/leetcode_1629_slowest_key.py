...
# where keysPressed[i] was the ith key pressed in the testing sequence,and a sorted list releaseTimes,
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1629.py")])
