...
#
# A sequence is special if it consists of a positive number of 0s,followed by a positive number of 1s,
# then a positive number of 2s.
#
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1955.py")])
