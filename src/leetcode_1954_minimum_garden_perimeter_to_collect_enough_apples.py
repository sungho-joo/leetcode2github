...
#
# In a garden represented as an infinite 2D grid,
# there is an apple tree planted at every integer coordinate.
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1954.py")])
