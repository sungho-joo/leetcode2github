...
# the player may remove any stone from stones.
...
class Solution:
    def stoneGameIX(self, stones: List[int]) -> bool:
        ...
        if min(stone_3[1], stone_3[2]) == 0:
            return max(stone_3[1], stone_3[2]) > 2 and stone_3[0] % 2 > 0
        else:
            return stone_3[0] % 2 == 0 or abs(stone_3[1] - stone_3[2]) > 2
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_2029.py")])
