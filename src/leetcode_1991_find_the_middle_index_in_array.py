...
# If middleIndex == 0,the left side sum is considered to be 0.Similarly,if middleIndex == nums.
# length - 1,the right side sum is considered to be 0.
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1991.py")])
