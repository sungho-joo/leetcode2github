...
# More formally,
# the rearranged array should have the property such that for every i in the range 1 <= i < nums.
...
class Solution:
    def rearrangeArray(self, nums: List[int]) -> List[int]:
        ...
        while first_ind < last_ind:
            ans.append(nums[first_ind])
            ans.append(nums[last_ind])
            first_ind += 1
            last_ind -= 1
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1968.py")])
