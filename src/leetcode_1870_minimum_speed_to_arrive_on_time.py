...
# representing the amount of time you have to reach the office.To commute to the office,
...
#
# For example,if the 1st train ride takes 1.5 hours,you must wait for an additional 0.
# 5 hours before you can depart on the 2nd train ride at the 2 hour mark.
#
...
class Solution:
    def minSpeedOnTime(self, dist: List[int], hour: float) -> int:
        ...
        total_time = lambda s: times(s) + dist[-1] / s
...
if __name__ == "__main__":
    ...
    pytest.main([os.path.join("tests", "test_1870.py")])
