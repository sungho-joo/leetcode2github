...
def init_variables_1770():
    from src.leetcode_1770_maximum_score_from_performing_multiplication_operations import (
        Solution,
    )
...
class TestClass1770:
    ...
    def test_solution_1(self, init_variables_1770):
        assert init_variables_1770().maximumScore([-5, -3, -3, -2, 7, 1], [-10, -5, 3, 4, 6]) == 102
