...
class TestClass1854:
    def test_solution_0(self, init_variables_1854):
        assert init_variables_1854().maximumPopulation([[1993, 1999], [2000, 2010]]) == 1993

    def test_solution_1(self, init_variables_1854):
        assert (
            init_variables_1854().maximumPopulation([[1950, 1961], [1960, 1971], [1970, 1981]]) == 1960
        )
#!/usr/bin/env python
...
class TestClass1854:
    ...
    def test_solution_1(self, init_variables_1854):
        assert init_variables_1854().                            maximumPopulation([[1950,1961],[1960,1971],[1970,1981]]) == 1960
