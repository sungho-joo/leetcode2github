...
class TestClass1839:
    def test_solution_0(self, init_variables_1839):
        assert init_variables_1839().longestBeautifulSubstring("aeiaaioaaaaeiiiiouuuooaauuaeiu") == 13

    def test_solution_1(self, init_variables_1839):
        assert init_variables_1839().longestBeautifulSubstring("aeeeiiiioooauuuaeiou") == 5
